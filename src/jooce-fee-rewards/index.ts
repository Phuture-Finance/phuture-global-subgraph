...
export function handleJooceTransfer(event: TransferEvent): void {
    ...
    if (event.params.from == Address.fromString("0x7f3823c4c8e3e70f2932e2ace7a6e8f4a598e5d2") && event.params.to == Address.fromString("0x004fd4bcc4c9989c18a1a1463241b7ccec9f7051")) {
